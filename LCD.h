...
#define LCD_BLUE       0x001F   //   0,   0, 255 0000 0000 0001 1111
#define LCD_DARKBLUE   0x34BF   //  50, 150, 255
#define LCD_RED        0xF800   // 255,   0,   0 1111 1000 0000 0000
#define LCD_GREEN      0x07E0   //   0, 255,   0 0000 0111 1110 0000
...
uint32_t BSP_LCD_DrawStringHighlight(int16_t x, int16_t y, char *pt, int16_t textColor);
//********BSP_LCD_SetCursor*****************
...
void BSP_LCD_OutUDec3(uint32_t n, int16_t textColor);
...
void BSP_LCD_MessageUDec3 (int device, int line, int col, char *string, unsigned int value);
